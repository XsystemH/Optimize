...
.PHONY: testIR
testIR:
	testcases/codegen/scripts/test_llvm_ir_reimu.bash 'java -cp /ulib/antlr-4.13.2-complete.jar:bin Main' testcases/codegen/e2.mx ./src/Backend/builtin/builtin.ll
